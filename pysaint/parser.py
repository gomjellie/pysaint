...
def make_sap_combo_select_event_queue(key_id, skey, sap_wd_secure_id):
    data = {
        'sap-charset': 'utf-8',
...
def make_sap_button_press_event_queue(button_id, sap_wd_secure_id):
    data = {
        'sap-charset': 'utf-8',
        'sap-wd-secure-id': sap_wd_secure_id,
        '_stateful_': 'X',
...
def make_sap_combo_select_with_button_press(key_id, skey, button_id, sap_wd_secure_id):
    data = {
        'sap-charset': 'utf-8',
        'sap-wd-secure-id': sap_wd_secure_id,
        '_stateful_': 'X',
...
def make_sap_tab_select_event(section_id, tab_id, item_index,sap_wd_secure_id):
    """
    :param section_id:
